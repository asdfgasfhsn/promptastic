...
#BRANCH1_PATCHED = u'\uE5FB'
DIVIDER_THIN_PATCHED = u'\uE0B1'
DIVIDER_LEFT_PATCHED = u'\uE0B1'
# DIVIDER_RIGHT_SOFT_PATCHED = u'\uE0B6'
...
DIVIDER_LEFT = DIVIDER_LEFT_PATCHED if config.PATCHED_FONTS else ''
WRITE_ONLY = LOCK if config.PATCHED_FONTS else PEN
DIVIDER_THIN = DIVIDER_THIN_PATCHED if config.PATCHED_FONTS else '/'
